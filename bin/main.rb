...
LIKE RETWEETS
-------------
Q: Would you like to favorite some retweets of your posts that you have not liked?
>> Enter 'y' for 'yes', or press any other key to skip
"
...
if reply == 'y'
  ...
  puts '| Nooo?! Your retweeters will be disappointed. |'
end
...
if choice == 'y'
  ...
  if YAML.load_file('fav_tweets.yml').is_a?(Array)
    puts "| Total Retweets Liked: |
    You have liked #{YAML.load_file('fav_tweets.yml').size} retweet(s) of your tweets.
    "
  else
